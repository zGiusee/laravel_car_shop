...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-12 d-flex justify-content-between align-items-center my-2">
            ...
            <a class="my_button" href="{{ route('admin.brands.create') }}"><i class="fa-solid fa-plus" style="color: #ffffff;"></i></a>
        </div>
        <div class="col-12">
                ...
                <tbody>
                    @foreach ($brands as $brand)
                        <tr>
                            ...
                            <td>{{ $brand->email }}</td>
                            <td>
                                <a class="my_button" href="{{ route('admin.brands.show', ['brand' => $brand->id]) }}"><i class="fa-solid fa-eye" style="color: #ffffff;"></i></a>
                                <a class="my_button" href="{{ route('admin.brands.edit', ['brand' => $brand->id]) }}"><i class="fa-solid fa-pen" style="color: #ffffff;"></i></a>
        
                                <button class="my_button delete_button" data-bs-toggle="modal" data-bs-target="#brands_delete_modal"
                                    type="button" data-id="{{ $brand->id }}" data-name="{{ $brand->name }}" data-type="brands">
